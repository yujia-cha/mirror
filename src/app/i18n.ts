...
export const STRINGS = {
  ...
  acqMaybeLong: { ko: '나올 수 있음', en: 'May drop' },
  ...
  // Step 3 — route
  optionFloorRange: { ko: '층 범위', en: 'Floors' },
  optionBandNormal: { ko: '1~5 · Normal', en: '1–5 · Normal' },
  ...
  optionHardSwitch: { ko: 'Hard로 전환', en: 'Switch to Hard' },
  optionHardLocked: { ko: 'Hard · 되돌릴 수 없음', en: 'Hard · cannot be undone' },
  optionHardAuto: {
    ko: '6층 이상은 1~5층 전부 Hard가 필요해 Hard로 계획합니다.',
    en: 'Floors 6+ need floors 1–5 cleared on Hard, so the plan is Hard from floor 1.',
  },
  optionObservation: { ko: '관측 최대', en: 'Max observed' },
  ...
  routeOutOfRange: { ko: '범위 밖', en: 'Out of range' },
  routeFreeRange: { ko: '자유 · {from}~{to}층', en: 'Free · {from}–{to}' },
  condMet: { ko: '충족', en: 'Met' },
  condUnmet: { ko: '미충족', en: 'Not met' },
  routeObservationImpossible: { ko: '관측 불가', en: 'No observation' },
  routeFuse: { ko: '합성', en: 'Fuse' },
  routeFuseAt: { ko: '{floor}층 이후 상점·휴식', en: 'Shop or rest from floor {floor}' },
  routeFusions: { ko: '조합', en: 'Fusions' },
  routeFusionImpossible: { ko: '재료를 모을 수 없음', en: 'Ingredients unavailable' },
  routeFusionSlots: { ko: '합성 칸 초과', en: 'Exceeds fusion slots' },
  routeGeneralDrops: { ko: '범용 드랍', en: 'General drops' },
  routeGeneralNotSure: { ko: '확정 아님', en: 'Not guaranteed' },
  routeGeneralHint: {
    ko: '어느 팩에서나 나올 수 있지만 보장되지 않습니다. 상점·새로고침을 함께 쓰세요.',
    en: 'These can drop from any pack but are never guaranteed; use the shop and refreshes.',
  },
  ...
  legendSure: { ko: '확정', en: 'Sure' },
  legendMaybe: { ko: '나올 수 있음', en: 'May drop' },
  legendEye: { ko: '관측 별빛', en: 'Observation starlight' },
  legendHatch: { ko: '관측 불가', en: 'No observation' },
