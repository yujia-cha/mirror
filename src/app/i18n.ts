...
export const STRINGS = {
  ...
  stageNoRoutePack: { ko: '이 층에 계획된 팩이 없습니다. 아무 팩이나 고르거나 「입장하지 않음」으로 넘기세요.', en: 'Nothing is planned for this floor. Enter any pack or skip it.' },
  ...
  stageSkip: { ko: '입장하지 않음', en: 'Skip this floor' },
  ...
  stagePrev: { ko: '이전 층', en: 'Previous floor' },
