...
export const STRINGS = {
  ...
  stageSkipHint: { ko: '이 층은 팩 없이 지나갑니다', en: 'Pass this floor without a pack' },
  stageEnter: { ko: '입장', en: 'Enter' },
  stageEnterPack: { ko: '{name} 입장', en: 'Enter {name}' },
  stageDetail: { ko: '자세히', en: 'Details' },
  stageDropZone: { ko: '여기로 끌어다 놓으면 입장', en: 'Drop here to enter' },
  stageDropHint: { ko: '팩을 아래로 끌거나 「입장」을 누르세요', en: 'Drag a pack down, or press Enter on it' },
  stageDragging: { ko: '{name} · 놓으면 입장', en: '{name} · release to enter' },
