...
export const STRINGS = {
  ...
  routeGoalsHint: { ko: '눌러서 획득 표시 · 무대의 팩 타일과 같은 기록 · 길게 누르면 정보', en: 'Tap to mark as got · the same record as the pack tiles on the stage · hold for details' },
  routeGoalsIngredients: { ko: '재료', en: 'Ingredients' },
