...
export const STRINGS = {
  ...
  runStart: { ko: '런 시작', en: 'Start run' },
  runEnd: { ko: '런 종료', en: 'End run' },
  runEndConfirm: { ko: '런 진행 기록(방문한 팩, 수집 상태)을 지우고 계획 화면으로 돌아갑니다.', en: 'This clears the run progress (visited packs, gift status) and returns to planning.' },
  runActive: { ko: '진행 중', en: 'In progress' },
  runCurrentFloor: { ko: '현재 층', en: 'Current floor' },
  runCurrentFloorHint: { ko: '들어갈 층', en: 'Next floor to enter' },
  runHint: { ko: '팩을 눌러 수집 상태와 방문 층을 기록하면 남은 층만 다시 계획합니다. 이 기기에만 저장됩니다.', en: 'Tap a pack to record gift status and the floor you entered it on; the floors ahead are re-planned. Saved on this device only.' },
  runVisited: { ko: '{floor}층 방문', en: 'Entered on floor {floor}' },
  runVisitedShort: { ko: '방문 · {floor}층', en: 'Entered · F{floor}' },
  runSetVisit: { ko: '방문 층 지정', en: 'Mark the floor entered' },
  runSetVisitHint: { ko: '노선도에서 이 팩에 들어간 층의 역을 누르세요. Esc로 취소.', en: 'Press the station of the floor you entered this pack on. Esc cancels.' },
  runSelecting: { ko: '{pack} · 들어간 층을 누르세요', en: '{pack} · press the floor you entered' },
  runSelectCancel: { ko: '취소', en: 'Cancel' },
  runSelectFloor: { ko: '{floor}층에서 {pack} 방문', en: 'Entered {pack} on floor {floor}' },
  runUnvisit: { ko: '방문 취소', en: 'Undo visit' },
  runPassed: { ko: '지남', en: 'Passed' },
  runFailedCount: { ko: '실패 {n}', en: '{n} missed' },
  giftStatusLabel: { ko: '{name} 수집 상태', en: '{name} status' },
  giftStatusPending: { ko: '수집 전', en: 'Pending' },
  ...
  aheadPacks: { ko: '앞으로 갈 수 있는 팩', en: 'Packs still ahead' },
  aheadPacksHint: { ko: '현재 층부터 들어갈 수 있는 팩과 전용 기프트. 팩을 눌러 기프트를 목표에 추가하거나 「이 팩으로」 지정합니다.', en: 'Packs you can still enter from the current floor, with their exclusive gifts. Open one to add gifts as goals or include the pack.' },
  aheadSearch: { ko: '팩 · 기프트 검색', en: 'Search packs and gifts' },
  aheadExclusives: { ko: '전용 {n}', en: '{n} exclusive' },
  aheadNone: { ko: '이 구간에 들어갈 수 있는 팩이 없습니다.', en: 'No pack can be entered in this band.' },
